...
export default function MensApparel() {
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#7CC0F4] mb-4">Men's Apparel</h1>
        <p className="text-gray-600">
          Discover our collection of high-quality men's clothing and accessories.
        </p>
      </div>
      ...
      <div className="mt-12 bg-gray-50 rounded-lg p-6">
        ...
        <div className="space-y-4 text-gray-600">
          ...
          <ol className="list-decimal list-inside space-y-2">
            ...
            <li>Make sure to categorize items as "mens" for them to appear here</li>
